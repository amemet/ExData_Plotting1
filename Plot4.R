...
#Plotting plot4
png(filename = "~/Coursera/R_Programming/Assignment2/ExData_Plotting1/plot4.png", width=480, height=480)
par(mfrow = c(2, 2), mar = c(4, 4, 2, 1), oma = c(0, 0, 2, 0))
plot(elcon_s$DateTime, elcon_s$Global_active_power, type = "l", ylab = "Global Actove Power (kilowatts)", xlab = "Daytime")
plot(elcon_s$DateTime, elcon_s$Voltage, type = "l", ylab = "Voltage", xlab = "Daytime")
...
plot(elcon_s$DateTime, elcon_s$Global_reactive_power, type = "l", ylab = "Global_reactive_power", xlab = "Datetime")
dev.off()
