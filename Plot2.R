...
#Plotting plot2
png(filename = "~/Coursera/R_Programming/Assignment2/ExData_Plotting1/plot2.png", width=480, height=480)
plot(elcon_s$DateTime, elcon_s$Global_active_power, type = "l", ylab = "Global Actove Power (kilowatts)")
dev.off()
